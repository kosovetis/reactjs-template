...
const archetypeDescriptions = {
  ...
  rebel: { name: "БУНТАРЬ", emoji: "⚡", color: "#991B1B", description: "Бросает вызов статус-кво, шокирует и нарушает правила, дает ощущение настоящей свободу.", traits: ["Нарушение правил", "Освобождение", "Дерзость", "Шок"], examples: ["Harley-Davidson","Diesel"] },
  ...
  explorer: { name: "ИССЛЕДОВАТЕЛЬ", emoji: "🧭", color: "#16A34A", description: "Расширяет горизонты и зовёт к приключениям, помогая открывать новое и сохраняя чувство свободы.", traits: ["Свобода", "Поиск", "Неутомимость"], examples: ["Jeep", "The North Face", "GoPro"] },
