    ...
    <div style={containerStyle}>
      ...
      <div style={ctaBlockStyle}>
        ...
        <div style={{ ...ctaTextStyle, textAlign: "center" as const }}>
          ...
          <p style={{ marginBottom: "16px" }}>
            У меня есть целый <strong>ГАЙД</strong>, из которого вы узнаете его темную сторону и суперсилы, какие ценности он транслирует вашей аудитории, и как не попасть в ловушку.
          </p>
