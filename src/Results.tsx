    ...
    <div style={containerStyle}>
      ...
      <div style={ctaBlockStyle}>
        ...
        <p style={ctaTextStyle}>
          ...
          У меня есть целый <strong> Гайд по архетипам брендов,</strong>
          из которого вы узнате, его темную сторону и суперсилы,
          какие ценности он транслирует и как не попасть в ловушку.
          А еще увидите на реальных кейсах, как архетипы 
          применяются в маркетинге.
        </p>
        <a
