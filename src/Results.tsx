...
const archetypeDescriptions = {
  caregiver: { name: "ЗАБОТЛИВЫЙ", emoji: "🤲", color: "#10B981", description: "Защищает и поддерживает — словно надёжный друг, который всегда подставит плечо, делая мир безопаснее.", traits: ["Сострадание", "Щедрость", "Желание помочь", "Альтруизм"], examples: ["Johnson & Johnson", "Nivea", "Pampers"] },
  ...
  magician: { name: "МАГ", emoji: "🪄", color: "#8B5CF6", description: "Воплощает невозможное, расширяя границы реальности и вдохновляя людей.", traits: ["Инновации", "Видение", "Трансформация", "Возможности"], examples: ["Apple", "Disney", "Dyson"] },
  ...
  creator: { name: "ТВОРЕЦ", emoji: "🎨", color: "#7C3AED", description: "Открывает возможности к самовыражени и созданию нового, воплощая идеи в уникальные формы и поощряя оригинальное видение.", traits: ["Креативность", "Воображение", "Самовыражение", "Оригинальность"], examples: ["Adobe", "LEGO", "Pinterest"] },
  rebel: { name: "БУНТАРЬ", emoji: "⚡", color: "#991B1B", description: "Бросает вызов статус-кво, шокирует и нарушает правила, дает ощущение настоящей свободу.", traits: ["Революция", "Освобождение", "Дикость", "Шок"], examples: ["Harley-Davidson","Diesel"] },
  ...
  everyman: { name: "СЛАВНЫЙ МАЛЫЙ", emoji: "🤝", color: "#059669", description: "«Такой же, как ты»: понимает повседневные заботы и создаёт ощущение домашнего уюта, где каждому рады.", traits: ["Принадлежность", "Реализм", "Сочувствие", "Дружелюбие"], examples: ["IKEA", "Пятерочка"] },
  ruler: { name: "ПРАВИТЕЛЬ", emoji: "👑", color: "#7C2D12", description: "Устанавливает порядок и поднимает планку, обещая превосходное качество и статус тем, кто следует за ним.", traits: ["Лидерство", "Ответственность", "Компетентность", "Престиж"], examples: ["Mercedes-Benz", "Rolex"] },
  innocent: { name: "НЕВИННЫЙ", emoji: "🌸", color: "#DB2777", description: "Луч света: дарит ощущение чистоты, надежды и радости маленьких моментов.", traits: ["Оптимизм", "Честность", "Чистота", "Простота"], examples: ["Coca-Cola", "Kinder"] },
  explorer: { name: "ИССЛЕДОВАТЕЛЬ", emoji: "🧭", color: "#16A34A", description: "Расширяет горизонты и зовёт к приключениям, помогая открывать новое и сохраняя чувство свободы.", traits: ["Свобода", "Аутентичность", "Амбиции", "Первопроходство"], examples: ["Jeep", "The North Face", "GoPro"] },
  lover: { name: "ЛЮБОВНИК", emoji: "❤️", color: "#BE185D", description: "Очаровывает эстетикой и чувственностью, дарит насыщенные эмоции и удовольствие, создавая атмосферу глубокой связи.", traits: ["Страсть", "Близость", "Красота", "Приверженность"], examples: ["Victoria's Secret", "Godiva"] }
};
